...
@Mod(ChemicallyExperimentalMod.MOD_ID)
public class ChemicallyExperimentalMod {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "chemically_experimental";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public ChemicallyExperimentalMod() {
